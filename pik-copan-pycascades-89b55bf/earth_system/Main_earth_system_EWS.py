...
gaussian_noise_include = True   # gaussian noise is incorporated
...
GMT_files = [np.linspace(0.0, 3.0, duration)]
#####################################################################
    ...
    for strength in coupling_strength:
        ...
        for GMT in GMTs:
            ...
            for t in range(0, int(duration)):
                ...
                if guassian_noise_include = True:
                    ...
                    ev.integrate(timestep, t_end, initial_state)
